    ...
    <body>
    	...
    	<div class="content-wrap">
    		<?php if(!empty($layanan)): ?>
	    		...
	    		<button class="btnCustomer" id="btnCustomer_<?php echo $value['id_layanan']; ?>" name="btnCustomer_<?php echo $value['id_layanan']; ?>" data-id="<?php echo $value['id_layanan']; ?>"><?php echo $value['nama_layanan']; ?></button>
	    		<?php endforeach; ?>
    		<?php endif; ?>
    	</div>
